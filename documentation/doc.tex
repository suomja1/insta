...
Sovelluksessa ei ole implementoitu käyttäjien rooleja. Toisin sanoen minkäänlaista moderointi-toiminnalisuutta ei ole toteutettu. Toistaiseksi myös kaikki poistamis- ja muokkaamistoiminnallisuudet puuttuvat.

Sivua ei löydy -virheen tavoin myös muuta virheviestit pitää luoda.

Palvelinpuolen välimuisti vaihdittaisi useampien kuvien lataamista.
\end{document}